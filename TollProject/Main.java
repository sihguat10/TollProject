...
public class Main extends Application{
    ...
    */
    ...
    public void exportRecordsPage(){
        ...
        //Choice for pdf or IMAGE
        //Checkboxes
        CheckBox boxPDF = new CheckBox("PDF");
        CheckBox boxJPG = new CheckBox("JPG");
        boxPDF.setSelected(true);

        Label checkBoxLabel = new Label("Would you like it exported to JPEG or PDF?");

        HBox hCheckBox = new HBox();
        hCheckBox.setPadding(new Insets(10,10,10,10));
        hCheckBox.setSpacing(10);
        hCheckBox.getChildren().addAll(boxPDF, boxJPG);
        ...
        submitExport.setOnAction(e-> {
            ...
            db.exportRecords(numbers, boxPDF.isSelected(), boxJPG.isSelected());
            mainPage();
        });
        //layout of window 
        VBox layout = new VBox();
        layout.getChildren().addAll(numLabel, hBoxExports,listExports, checkBoxLabel, hCheckBox, 
