...
public class DBIO {
  ...
  public static ArrayList<Record> loadDB ( String fileName ) {
    ...
    FTPdownload ftp = new FTPdownload("ftp.wcginteractive.com", 21, "toll@wcginteractive.com", "Wcg@2019");
  ...
  private static Work [] readWorkArrayFromFile (
    ...
    //makes sure to divide it into 6 sections for each work 
    line=null;
    int i=0;
    String description="";
    while(true){
